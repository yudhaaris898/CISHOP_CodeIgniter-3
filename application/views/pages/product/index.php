            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <p>
                                <img src="<?= $row->image ? base_url("images/product/$row->image") : base_url("images/product/default.png") ?>" alt="" height="60" width="60">
                                <?= $row->product_title ?>
                            </p>
                        </td>
                        <td>
                        ...
                        <td>
                            ...
                            <?= form_hidden('id', $row->id) ?>
                                ...
                                <button class="btn btn-sm" type="submit" onclick="return confirm('Yakin mau hapus produk ini?')">
