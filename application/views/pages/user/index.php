               ...
               <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <p>
                                <img src="<?= $row->image ? base_url("images/user/$row->image") : base_url("images/user/avatar.jpg") ?>" alt="" height="60" width="60">
                                <?= $row->name ?>
                            </p>
                        </td>
                        <td><?= $row->email ?></td>
                        ...
                        <td>
                            ...
                            <?= form_hidden('id', $row->id) ?>
                                ...
                                <button class="btn btn-sm" type="submit" onclick="return confirm('Yakin mau hapus pengguna ini?')">
