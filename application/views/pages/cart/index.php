                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form action="<?= base_url("cart/delete/$row->id") ?>" method="POST">
                                        <input type="hidden" name="id" value="<?= $row->id ?>">
                                        <button class="btn btn-danger" type="submit" onclick="return confirm('Yakin mau hapus produk ini?')"><i class="fas fa-trash-alt"></i></button>
                                    </form>
                                </td>
                            </tr>
                            <?php endforeach ?>
                            <tr>
                                ...
                                <td class="text-center border-0"><strong>Rp<?= number_format(array_sum(array_column($content, 'subtotal')), 0, ',', '.') ?>,-</strong></td>
